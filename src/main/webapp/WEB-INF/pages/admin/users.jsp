...
<div class="container">
    ...
    <h3>管理员添加用户<a href="${pageContext.request.contextPath}/admin/users/add" type="button">添加</a></h3>
    <hr/>
    <!-- 如果用户列表为空 -->
    <c:if test="${empty userList}">
        <div class="alert alert-warning" role="alert">
            <span class="glyphicon glyphicon-info-sign" aria-hidden="true"></span>User表为空，请
            <a href="${pageContext.request.contextPath}/admin/users/add" type="button" class="btn btn-primary btn-sm">添加</a>
        </div>
    </c:if>
